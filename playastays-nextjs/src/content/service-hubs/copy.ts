...
export const SERVICE_HUB_REGISTRY: ServiceHubRegistry = {
  'property-management': {
    en: {
      ...
      whatTitle: 'A single operating system for your property—not a one-size template',
      whatBody: [
        'PlayaStays property management is designed for owners who need dependable operations: leases and calendars, capex planning, inspections, HOA coordination, and clear reporting. We are not a thin “listing service”—we are the team that keeps the asset functioning, compliant, and financially visible.',
        'This page explains our service at a regional level. For neighborhood dynamics, building-specific realities, and localized FAQs, open the city page that matches your property—Playa del Carmen, Tulum, Puerto Morelos, and more.',
      ],
      includesEyebrow: 'What’s included',
      includesTitle: 'Ownership operations we run across our markets',
      includesLead:
        'Scope adjusts by property type and strategy; the through-line is accountability and local execution.',
      includesItems: [
        {
          title: 'Strategy & leasing',
          desc: 'Long-term, short-term, or hybrid roadmaps aligned to your goals—not generic “always Airbnb.”',
        },
        {
          title: 'Maintenance & vendors',
          desc: 'Trusted local trades, preventive maintenance, and rapid response when issues threaten revenue or asset value.',
        },
        {
          title: 'Compliance & documentation',
          desc: 'HOA rules, permits, insurance coordination, and recordkeeping your accountant can rely on.',
        },
        {
          title: 'Financial visibility',
          desc: 'Owner reporting that answers what you earned, what you spent, and what needs attention next.',
        },
        {
          title: 'Asset protection',
          desc: 'Inspections, turnover quality standards, and vendor oversight that protect condition and resale value.',
        },
        {
          title: 'Local leadership',
          desc: 'A bilingual team embedded in each market—same standards, market-specific execution.',
        },
      ],
      processEyebrow: 'How it works',
      processTitle: 'From introduction to a running operation',
      processLead: 'A structured path so expectations, scope, and reporting are clear from day one.',
      processSteps: [
        {
    ...
    es: {
      ...
      whatTitle: 'Un sistema operativo para tu propiedad',
      whatBody: [
        'La administración PlayaStays está pensada para dueños que necesitan operación confiable: contratos y calendarios, capex, inspecciones, condominio y reportes claros. No es un servicio superficial de “anuncio”: es el equipo que mantiene el activo funcionando y visible financieramente.',
        'Esta página es regional. Para colonias, edificios y preguntas locales, abre el hub de tu ciudad.',
      ],
      includesEyebrow: 'Qué incluye',
      includesTitle: 'Operación de propiedad en nuestros mercados',
      includesLead: 'El alcance varía por tipo de propiedad; la constante es responsabilidad y ejecución local.',
      includesItems: [
        { title: 'Estrategia y arrendamiento', desc: 'Modelos largo plazo, corto plazo o híbridos alineados a tus metas.' },
        { title: 'Mantenimiento y proveedores', desc: 'Oficios de confianza, preventivo y respuesta rápida ante riesgos.' },
        { title: 'Cumplimiento y expediente', desc: 'Reglas de condominio, permisos y documentación para tu contador.' },
        { title: 'Visibilidad financiera', desc: 'Reportes que responden qué ganaste, qué gastaste y qué sigue.' },
        { title: 'Protección del activo', desc: 'Inspecciones y estándares de calidad que cuidan condición y reventa.' },
        { title: 'Liderazgo local', desc: 'Equipo bilingüe en cada mercado con estándares comunes.' },
      ],
      processEyebrow: 'Cómo funciona',
      processTitle: 'De la conversación a la operación',
      processLead: 'Un camino claro para alcance, cumplimiento y reportes desde el día uno.',
      processSteps: [
